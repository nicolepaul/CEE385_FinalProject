...
%% ---------------------------------------------------------------------------
    function updatelosses_Callback(hObject,evendata) %#ok<INUSD>
        ...
        % Store information
        [EL, P, bldgEL_im, floorEL_im, compEL_im, IM, AAL] = calc_lossCurve(handles.fragDat, handles.imval, handles.stripeDat, nedps, nfloors, handles.pcoeff, EC, handles.cqty', handles.dqty', dfrag);
...
%             % less than 2.0g
%             ndeg = 4;
%             inds = find(handles.shcdat(:,1)<2);
%             pcoeff = polyfit(log(handles.shcdat(inds,1)), log(handles.shcdat(inds,2)), ndeg);
%             
%             % Calculate at same points of hazard curve
