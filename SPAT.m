...
%% ---------------------------------------------------------------------------
    function updatelosses_Callback(hObject,evendata) %#ok<INUSD>
        ...
        % Store information
        [EL, P, bldgEL_im, floorEL_im, compEL_im, IM] = calc_lossCurve(handles.fragDat, handles.imval, handles.stripeDat, nedps, nfloors, handles.pcoeff, EC, RIDR_HC);
