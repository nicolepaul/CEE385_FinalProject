...
%% ---------------------------------------------------------------------------
    function build_gui()
        ...
        handles.outloss7 = uicontrol( ...
            'Parent', handles.OUTPUTS5, ...
            'Tag', 'outloss7', ...
            'Style', 'text', ...
            'Units', 'characters', ...
            'Position', ppinv.*[5 2.2 40 1], ...
            'FontName', 'Helvetica', ...
            'FontSize', 10, ...
            'BackgroundColor', [1 1 1], ...
            'String', 'x           x           x', ...
        ...
        handles.outputheader2 = uicontrol( ...
            'Parent', handles.OUTPUTS2, ...
            'Tag', 'outputheader5', ...
            'UserData', zeros(1,0), ...
            'Visible', 'on', ...
            'Style', 'text', ...
            'Units', 'characters', ...
            'Position', ppinv.*[2 17 55 1], ...
            'FontName', 'Helvetica', ...
            'FontSize', 11, ...
            'FontWeight', 'bold', ...
            'BackgroundColor', [1 1 1], ...
            'String', 'SEISMIC RESPONSE OUTPUTS:', ...
            'HorizontalAlignment', 'left');
        
        handles.outputheader5 = uicontrol( ...
            'Parent', handles.OUTPUTS5, ...
            'Tag', 'outputheader5', ...
            'UserData', zeros(1,0), ...
            'Visible', 'on', ...
        ...
        handles.pickpiecat = uicontrol( ...
            ...
            'Value', 1, ...
            'BackgroundColor', [1 1 1], ...
            'String', {'Case','Component','Floor','EDP'}, ...
            'Callback', @pickpiecat_Callback);
...
%% ---------------------------------------------------------------------------
    function updatelosses_Callback(hObject,evendata) %#ok<INUSD>
        ...
        set(handles.outloss6,'str',AALv_str);
...
%% ---------------------------------------------------------------------------
    function imLoss_Callback(hObject,evendata) %#ok<INUSD>
        ...
        ELp_str = sprintf('R: %10.1f%%     D: %10.1f%%     C: %10.1f%%',100*el_interp(1:3)./el_interp(end));
        set(handles.outloss3,'str',ELv_str);
        set(handles.outloss4,'str',ELp_str);
...
%% ---------------------------------------------------------------------------
    function pickpiecat_Callback(hObject,evendata) %#ok<INUSD>
        ...
        % Plotting pie chart
        if pietype == 2
            % Pie charts for E[L|IM]
            imvalue = str2double(get(handles.imloss,'str'));
            if isnan(imvalue)
